  ...
  <div class="content-header">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
        <div class="col-md-4 " style="margin-left: 0px;"> <!-- Added 'text-right' class here -->
            <a href="#">
                <img src="{{asset('images/patients/'.Auth::user()->pic)}}" width="150px" height="150px"/>
            </a><br>
            <h3 style="display: inline-block; margin-left: 30px;"> @if(Auth::user())
          <a href="#" class="d-block">{{Auth::user()->name}}</a>
          @else
          <a href="#" class="d-block">Patient dashboard</a>
          @endif       </h3>
        ...
        <div class="col-md-8">
            ...
            <label for="exampleInputEmail1">patient: <h6 style="display: inline-block; margin-left: 10px;"> @if(Auth::user())
          <a href="#" class="d-block">{{Auth::user()->name}}</a>
          @else
          <a href="#" class="d-block">Patient name</a>
          @endif       </h6></label><br>
            <label for="exampleInputEmail1">Patient Number:<h6 style="display: inline-block; margin-left: 10px;"> @if(Auth::user())
          <a href="#" class="d-block">{{Auth::user()->email}}</a>
          @else
          <a href="#" class="d-block">Patient contact</a>
          @endif       </h6></label><br>
            <label for="exampleInputEmail1">Patient status:  <h6 style="display: inline-block; margin-left: 10px;">  @if(Auth::user())
          <a href="#" class="d-block">{{Auth::user()->status}}</a>
          @else
          <a href="#" class="d-block">Patient status</a>
          @endif       </h6></label><br>
