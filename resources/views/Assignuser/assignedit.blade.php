               ...
               @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="RoleName" value="{{$assign->RoleName}}" class="form-control" id="permission" placeholder="Enter RoleName">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">category name</label>
                    <input type="text" name="username" value="{{$assign->username}}" class="form-control" id="permission" placeholder="Enter userName">
                  </div>
                  <div class=" mt-n2 mb-3 fw-bold fs-6 text-danger">
                  @if($errors->has('name'))
                    {{$errors->first('name')}}
                  @endif
               <input type="hidden" value="{{$assign->id}}" name="id"/>
